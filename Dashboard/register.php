...
<body>
  <div class="container"> 
    <div class="row content">
      <div class="col-md-6">
         <form method="POST" action="../app/model/user/user-register.php">
              ...
              <div class="form-group">
                <label>noTlp </label>
                <input type="number" name="tlp" required="" class="form-control">
              </div>
              <div class="form-group">
                <label>Alamat </label>
              ...
              <a href="login.php" class="btn btn-warning btn-md mt-2 text-white">Back</a>
          </form>
      </div>
    </div>
  </div>
